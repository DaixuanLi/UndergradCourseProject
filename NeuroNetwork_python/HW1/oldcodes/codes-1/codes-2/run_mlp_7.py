...
NAME = "3layersRelu.Cross"
train_data, test_data, train_label, test_label = load_mnist_2d('data')

# Your model defintion here
# You should explore different model architecture
model = Network()
model.add(Linear('fc0', 784, 500, 0.01, 'relu', 'act1'))
model.add(Linear('fc1', 500, 400, 0.01, 'relu', 'act1'))
model.add(Linear('fc', 400, 256, 0.01, 'relu', 'act1'))
