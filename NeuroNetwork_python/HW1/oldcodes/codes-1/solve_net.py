...
def train_net(model, loss, config, inputs, labels, batch_size, disp_freq, test_inputs, test_labels):
    ...
    for input, label in data_iterator(inputs, labels, batch_size):
        ...
        test_loss_value, test_acc_value = test_net(model, loss, test_inputs, test_labels, 10000000)
