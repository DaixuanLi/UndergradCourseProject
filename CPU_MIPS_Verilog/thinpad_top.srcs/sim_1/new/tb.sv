...
parameter BASE_RAM_INIT_FILE = "data/kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�??
parameter EXT_RAM_INIT_FILE = "/tmp/data/kernel.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�??
...
initial begin 
    ...
    reset_btn = 0;
    #1000000
    cpld.pc_send_byte(8'h52);  // G   
end
    //#10000;
    //cpld.pc_send_byte(8'h0d);  // \n
    //#1000000;
    //cpld.pc_send_byte(8'h38);  // 8000200c
    //#1000;
    ...
    // reset_btn = 0;
    // 模拟PC通过串口发�?�字�??
    // for (integer i = 0, data = 1; i < 10; i = i + 1, data = data + 1) begin
